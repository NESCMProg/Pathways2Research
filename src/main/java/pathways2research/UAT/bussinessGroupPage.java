...
public class bussinessGroupPage extends base {
	...
	WebElement firstBussinessArticle;
	...
	@FindBy(xpath = "//a[contains(text(),'PDF view')]")
	WebElement pdfBtn;
	...
	public bussinessGroupPage() {
		PageFactory.initElements(driver, this);
	}
	
	
	public void businessEconomicsTG() throws InterruptedException, AWTException {
		...
		bookmarkIcon.click();
		Log.info("clicked on bookmark in Business and Economics group");
		...
		pdfBtn.click();
		Thread.sleep(4000);
		Log.info("clicked on PDF Link in Business and Economics group");
		...
		Thread.sleep(2000);
		Log.info("clicked on Google Drive link in Business and Economics group");
