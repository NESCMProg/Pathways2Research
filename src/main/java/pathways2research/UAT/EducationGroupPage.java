...
public class EducationGroupPage extends base {
	...
	WebElement firstEducationArticle;
	...
	public EducationGroupPage() {
		PageFactory.initElements(driver, this);
	}

	public void validateEducationTG() throws InterruptedException, AWTException {
		...
		pdfBtn.click();
		Thread.sleep(4000);
		Log.info("clicked on PDF Link in Education group");
		...
		Thread.sleep(2000);
		Log.info("clicked on Google Drive link in Education group");
